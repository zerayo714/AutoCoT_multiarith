...
def main():
    ...
    # print(os.getenv("sk-o9BYq1l1F3IHXX4q5AVuT3BlbkFJSTlsmQvS4X4gqjHGjfXKY")[0:5] + '**********')
    ...
    elif args.method == "few_shot_cot" or args.method == "auto_cot":   # Default是auto_cot
    ...
    with open(args.output_dir, "a") as wp:
        ...
        for i, data in enumerate(dataloader):
            ...
            if args.method == "zero_shot":
                ...
                x = demo + x
            elif args.method == "auto_cot":  # Default
            ...
            if args.method == "zero_shot_cot":
                ...
                pred = z
                print(x + pred) # Q + A + "The answer is" + pred_Ans
            ...
            print("答對題數：{}".format(sum(correct_list)))
            

            total += 1 #np.array([y]).size(0)
            count = count + 1
            print("累計題數： " + str(count))
            if count == 297:
                break
             # Calculate accuracy ...
            accuracy = (sum(correct_list) * 1.0 / total)
